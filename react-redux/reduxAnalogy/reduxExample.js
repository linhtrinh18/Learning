// This is the redux example file:
const Redux = require('./reduxCdn')
...
store.dispatch(createPolicy('Jimmy'));
store.dispatch(createClaim('Alex', 70));

store.dispatch(createPolicy('Linh'));
store.dispatch(createClaim('Linh', 20));
